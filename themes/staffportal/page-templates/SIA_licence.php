...
$mylink = $wpdb->get_row("SELECT * FROM sia_licence WHERE sia_user_id = $si_user_id");
// $mylink->sia_user_id;
	if ($mylink != null) {
			
$wpdb->query("UPDATE sia_licence SET select_licence='$si_country',visa_expiry='$si_date_expire',licence_number='$si_licence_number',sia_licence='$si_copy_licence' WHERE sia_user_id = $si_user_id"); 
 $update_mes = "Your data has been updated successfully.";

//echo 	"UPDATE sia_licence SET select_licence='$si_country',visa_expiry='$si_date_expire',licence_number='$si_licence_number',sia_licence='$si_copy_licence' WHERE sia_user_id = $si_user_id";
	}
		else{	
...
$insert_mes = "Your data has been submitted successfully.";
		...
		//wp_redirect( get_bloginfo('wpurl').'/sia-licence-details', 301 ); 
...
<section class="lor1">
  <div class="lol2">
    <div class="das1">
      <div class="das2">
        <form action="#" method="post" enctype="multipart/form-data" id="sia_from">
            ...
            <div class="das2_3 das2_4">
              <div class="ped1">
                <div class="ped2">
                  ...
                  <select name="country" class="mnp_sel" >  
                  <?php 
				  //echo "<pre>";
				  $sia_data1 = $wpdb->get_results("SELECT * FROM sia_licence_type");
				// print_r($sia_data1);
				?>
				<option value="">-- Select Type --</option>
				  
                  <?php foreach($sia_data1 as $country){ 
                  $a = $country->licence_type; ?>
                ...
                <div class="ped2">
                  ...
                  <div class="ped6">
                    <div class="ped7 ped8">
                      <input type="text" name="licence_number" placeholder="SIA Licence Number"  value="<?php echo $sia_data->licence_number;  ?>"/>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="ped2">
                ...
                <div class="ped6">
                  <div class="ped7 ped11">
                    <input class="datepicker" type="text" name="sia_date_expire" placeholder="Date of Visa Expiry"  value="<?php echo $sia_data->visa_expiry;  ?>">
                  </div>
                </div>
              </div>
            </div>
