							...
							<div class="ped2">
								...
								<div class="ped6">
                                    ...
                                    <?php $nati = $doc_form->nationality ; ?>
										 <select name="nationality" class="mnp_sel" required="required" id="natina">  
							...
							<div class="ped2">
								...
								<div class="ped6">
                                    ...
                                    <?php $ethn = $doc_form->ethnicity ; ?>
										 <select name="ethnicity" class="mnp_sel" required="required" id="ethinict">  
