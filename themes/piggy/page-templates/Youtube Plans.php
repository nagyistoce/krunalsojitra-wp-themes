...
<div class="navi in_con dism1">
  <div class="navi1">
    <div class="in_con1">
      <div class="in_con2">
        <h1> <?php echo get_field('youtube_plans_title'); ?> </h1>
      </div>
    </div>
    <div class="in_con1">
      <div class="dism2"> <img src="<?php echo get_field('youtube_image'); ?>" /> </div>
      <div class="dism3"> <?php echo get_field('youtube_plans_desctiprion'); ?> </div>
    </div>
  </div>
</div>
<? endwhile;?>
<div class="navi in_con">
  <div class="navi1">
    <div class="package_middle packa6">
      ...
      <?php
	        $args = array( 'post_type' => 'product', 'product_cat' => 'youtube-plans', 'order' => 'ASC');
