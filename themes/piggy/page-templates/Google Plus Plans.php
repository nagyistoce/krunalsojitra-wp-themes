<?php
/**
 * Template Name:  Google Plus Plans
 *
...
<div class="navi in_con dism1">
  <div class="navi1">
    <div class="in_con1">
      <div class="in_con2">
        <h1> <?php echo get_field('google_plus_plans_title'); ?> </h1>
      </div>
    </div>
    <div class="in_con1">
      <div class="dism2"> <img src="<?php echo get_field('google_plus_image'); ?>" /> </div>
      <div class="dism3"> <?php echo get_field('google_plus_description'); ?> </div>
    </div>
  </div>
</div>
<? endwhile;?>
<div class="navi in_con">
  <div class="navi1">
    <div class="package_middle packa6">
      ...
      <?php
	        $args = array( 'post_type' => 'product', 'product_cat' => 'google-plus-plans', 'order' => 'ASC');
    ...
    <div class="packa1 packa7">
      <div class="panel-group" id="accordion">
        <?php
	        $args = array( 'post_type' => 'product', 'product_cat' => 'goole-plus-plans', 'order' => 'ASC');
        $loop = new WP_Query( $args );
