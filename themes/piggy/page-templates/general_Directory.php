<?php
/**
 * Template Name: General Directory Template
 *
...
<div class="navi in_con">
    ...
    <!-------------------------------------------Bulk (No Taget) traffic  start------------------------------------------------>        
		<div class="middle_01 resp_mi1">
         ...
         <?php
	        $args = array( 'post_type' => 'product', 'product_cat' => 'no-taget-directory', 'order' => 'ASC');
  ...
  <!-------------------------------------------Niche (Category) Targeted Traffic start------------------------------------------------>      
		...
		<div class="middle_01 middle_02 resp_mi1">
			<h2>Niche (Category) Targeted Directory</h2>
			<div class="middle_1">
				<div class="middle_11"> Package Name </div>
				<div class="middle_12"> Price </div>
				<div class="middle_13"> Buy </div>
            ...
            <?php
	        $args = array( 'post_type' => 'product', 'product_cat' => 'targeted-directory', 'order' => 'ASC');
        $loop = new WP_Query( $args );
 ...
 <!----------------------------Niche (Category) & Geo (Country) Targeted Traffic  start----------------------------------------->        
		<div class="middle_01 middle_03 resp_mi1">
			<h2>Niche (Category) & Geo (Country) Targeted Directory</h2>
			<div class="middle_1">
				<div class="middle_11"> Package Name </div>
				<div class="middle_12"> Price </div>
				<div class="middle_13"> Buy </div>
			...
			<?php
	        $args = array( 'post_type' => 'product', 'product_cat' => 'country-targeted-directory', 'order' => 'ASC');
        $loop = new WP_Query( $args );
