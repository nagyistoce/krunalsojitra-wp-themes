<?php
/**
 * Template Name: Twitter Followers Template
 *
...
<div class="navi in_con dism1">
	<div class="navi1">
		<div class="in_con1">
			<div class="in_con2">
				<h1>
					<?php echo get_field('twitter_plans_title'); ?>
				</h1>
			</div>
		</div>
		<div class="in_con1">
			<div class="dism2">
				<img src="<?php echo get_field('twitter_image'); ?>" />
			</div>
			<div class="dism3">
...
<div class="navi in_con">
  <div class="navi1">
    <div class="package_middle packa6">
      ...
      <?php
	        $args = array( 'post_type' => 'product', 'product_cat' => 'twitter-plans', 'order' => 'ASC');
            ...
            if(in_array($cat->term_id, $terms)) {
			 ...
			 ?>
				<div class="in_con3">
					<div class="in_con4">
						<div class="in_con5">
							 <?php echo '<img src="'.$image.'" alt="'. $cat->name .'"/>';?>
							<p>
								<?php echo  $cat->name ;?>
							</p>
						</div>
