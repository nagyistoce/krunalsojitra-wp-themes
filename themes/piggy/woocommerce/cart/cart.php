	...
	<thead>
		<tr>
			...
			<th class="product-name"><?php _e( 'Product', 'woocommerce' ); ?></th>
             <th class="product-date">Delivery Date</th>
...
<!-- Product Name -->
<div class="part_2">
<div class="nam2"><?php _e( 'Product', 'woocommerce' ); ?></div>
...
<!-- Delivery Date -->
<div class="part_3">
<div class="nam3">Delivery Date</div>
<div class="nam_dec3">
...
<!-- Product price -->
<div class="part_4">
<div class="nam4"><?php _e( 'Price', 'woocommerce' ); ?></div>
<div class="nam_dec4">
...
<!-- Quantity inputs -->
<div class="part_5">
<div class="nam5"><?php _e( 'Quantity', 'woocommerce' ); ?></div>
<div class="nam_dec5">
						<?php
								if ( $_product->is_sold_individually() ) {
									$product_quantity = sprintf( '1 <input type="hidden" name="cart[%s][qty]" value="1" />', $cart_item_key );
...
<!-- Product subtotal -->
<div class="part_6">
<div class="nam6"><?php _e( 'Total', 'woocommerce' ); ?></div>
<div class="nam_dec6">
