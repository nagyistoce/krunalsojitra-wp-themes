		...
		<div class="packege-box" >
            ...
            <div class="clear"></div>
				...
				<script language="javascript" type="text/javascript">
					...
					protelWBE.TemplatePath = "/martinhal/wp-content/themes/martinhal/booking-engine/";
					protelWBE.Init();
				</script>
...
<!----<style>
	...
	.wbe4Wrapper #MemberContent{  width: 24.1em;padding:0;}
	...
	.wbe4Wrapper #search-button.searchLine, .wbe4Wrapper #responsiveLogin-button.searchLine{}
	.searchLineFull .searchLine{text-align: left;}
	.wbe4Wrapper #HotelTabs li:hover{background-color: #67B8DE;
    border-color: #67B8DE; padding: 2.5px;}
...
.tableBox.fixIE8Table {    clear: both;    float: left;}
