...
function twentytwelve_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Portuguese NewsLetter', 'twentytwelve' ),
		'id' => 'sidebar-1',
	...
	register_sidebar( array(
		'name' => __( 'UK NewsLetter', 'twentytwelve' ),
		'id' => 'sidebar-2',
		'description' => __( 'UK NewsLetter', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'German NewsLetter', 'twentytwelve' ),
		'id' => 'sidebar-3',
	...
	register_sidebar( array(
		'name' => __( 'Spanish NewsLetter', 'twentytwelve' ),
		'id' => 'sidebar-4',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		'name' => __( 'French NewsLetter', 'twentytwelve' ),
		'id' => 'sidebar-5',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		'name' => __( 'Italian NewsLetter', 'twentytwelve' ),
		'id' => 'sidebar-6',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		'name' => __( 'Dutch NewsLetter', 'twentytwelve' ),
		'id' => 'sidebar-7',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		'name' => __( 'Russian NewsLetter', 'twentytwelve' ),
		'id' => 'sidebar-8',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		'name' => __( 'Chinese NewsLetter', 'twentytwelve' ),
		'id' => 'sidebar-9',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
...
// function add_first_and_last($output) {
  ...
  // $output = substr_replace($output, 'class="last-menu-item menu-item last', strripos($output, 'class="menu-item'), strlen('class="menu-item'));
  // return $output;
// }
...
/*--------------------------------------------------------------------------------------------------
	Martinhal Header Custom Post Type
--------------------------------------------------------------------------------------------------*/
...
function header_area() {
  $labels = array(
    ...
    'not_found_in_trash' => 'No header in Trash',
    'parent_item_colon'  => '',
    'menu_name'          => 'Header'
  );
...
add_action( 'init', 'header_area' );


/*--------------------------------------------------------------------------------------------------
	Martinhal Footer Custom Post Type
--------------------------------------------------------------------------------------------------*/
...
function footer() {
  $labels = array(
    ...
    'not_found_in_trash' => 'No footer in Trash',
    'parent_item_colon'  => '',
    'menu_name'          => 'Footer'
  );
...
/*--------------------------------------------------------------------------------------------------
	Martinhal Special Offers Custom Post Type
--------------------------------------------------------------------------------------------------*/
...
/*--------------------------------------------------------------------------------------------------
	Martinhal Special Inner page Slider Custom Post Type
--------------------------------------------------------------------------------------------------*/

function inner_slider() {
  $labels = array(
    'name'               => 'Slider',
  ...
  $args = array(
    ...
    'show_in_menu'       => true,
    'query_var'          => true,
    'rewrite'            => array( 'slug' => 'inner_slider' ),
    'capability_type'    => 'post',
    'has_archive'        => true,
    'hierarchical'       => false,
    'menu_position'      => null,
  ...
  register_post_type( 'inner_slider', $args );
}
add_action( 'init', 'inner_slider' );

/*--------------------------------------------------------------------------------------------------
	Martinhal Press page  Custom Post Type
--------------------------------------------------------------------------------------------------*/
...
/*--------------------------------------------------------------------------------------------------
	Martinhal Award page  Custom Post Type
--------------------------------------------------------------------------------------------------*/
...
add_action( 'init', 'award' );

// Added for removing the index.php in the permalink by Pankaj
//global $is_apache;
//$is_apache = true;
//login logo
