<?php
/**
 * Template Name: Inner Ocean House Slider
 *
...
get_header(); ?>
	...
	?>
        ...
        <?php if(get_field('slider_image', 813)): ?>
            <?php while(has_sub_field('slider_image', 813)): ?>
    ...
    <?php endwhile; ?>
        ...
        <?php if(get_field('content', 813)): ?>
        	<?php echo get_field('content', 813); ?>
        	   <?php endif; ?>
