<?php
/**
 * Template Name: Inner Beach Room slider
 *
...
get_header(); ?>
	...
	?>
        ...
        <?php if(get_field('slider_image', 2105)): ?>
            <?php while(has_sub_field('slider_image', 2105)): ?>
    ...
    <?php endwhile; ?>
        ...
        <?php if(get_field('content', 2105)): ?>
        	<?php echo get_field('content', 2105); ?>
        	   <?php endif; ?>
