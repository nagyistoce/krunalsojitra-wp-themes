<?php
/**
 * Template Name: Inner Bay Houses Slider
 *
...
get_header(); ?>
	...
	?>
        ...
        <?php if(get_field('slider_image', 839)): ?>
            <?php while(has_sub_field('slider_image', 839)): ?>
    ...
    <?php endwhile; ?>
        ...
        <?php if(get_field('content', 839)): ?>
        	<?php echo get_field('content', 839); ?>
        	   <?php endif; ?>
