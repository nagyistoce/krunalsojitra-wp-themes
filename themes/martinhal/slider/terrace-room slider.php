<?php
/**
 * Template Name: Inner Terrace Room slider
 *
...
get_header(); ?>
	...
	?>
        ...
        <?php if(get_field('slider_image', 2064)): ?>
            <?php while(has_sub_field('slider_image', 2064)): ?>
    ...
    <?php endwhile; ?>
        ...
        <?php if(get_field('content', 2064)): ?>
        	<?php echo get_field('content', 2064); ?>
        	   <?php endif; ?>
