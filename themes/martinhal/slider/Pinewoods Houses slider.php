<?php
/**
 * Template Name: Inner Pinewoods Houses slider
 *
...
get_header(); ?>
	...
	?>
        ...
        <?php if(get_field('slider_image', 1841)): ?>
            <?php while(has_sub_field('slider_image', 1841)): ?>
    ...
    <?php endwhile; ?>
        ...
        <?php if(get_field('content', 1841)): ?>
        	<?php echo get_field('content', 1841); ?>
        	   <?php endif; ?>
