...
if(isset($_POST['home_submit']))
{
        ...
        // Address must be word characters only
         ...
         if (intval($_POST['hiddenans']) == intval($_POST['answer'])){
				...
				$message .= "Device/Browser: ".$_SERVER['HTTP_USER_AGENT']."\n"; 
				 ...
				 $mail = mail('info@letsnurture.com', $subject, $message, $header); 
			     if($mail){
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var test = '<?php if(isset($_POST['scrollbottom'])) echo '1'; else echo '0';?>';
		if(test == 1){
...
header.sml-hd .logo a img {
	width: 183px;
}
header.sml-hd a.get-but {
	margin-top: 9px;
}
header.sml-hd nav ul {
	margin-top: 20px;
}
.sml-hd .header_faq a {
border-bottom;
...
header.sml-hd nav ul.desk-menu li .fst_lev {
	font-size: 17px;
}
</style>
  ...
  <div class="container">
    ...
    <div class="slidercont">
      <ul class="slides">
        ...
        <li>
          <h1 class="animated" data-animation="bounceInDown" data-revert="bounceOutUp">
            <?php the_sub_field('title'); ?>
          </h1>
          <a class="cta animated" data-animation="flipInX" data-revert="flipOutX" href="<?php the_sub_field('link'); ?>">
    ...
    <a class="read-more" href="#services"><img src="<?php bloginfo('template_directory'); ?>/images/read-more.png" /></a> </div>
  <!--container --> 
</div>
<div class="section" id="services"> 
  ...
  <div class="container">
    ...
    <p class="animated" data-animation="flipInX" data-revert="flipOutX">
    ...
    <ul>
      <?php 
				...
				{
				?>
      <li> <a href="<?php the_sub_field('service_url'); ?>"> <img class="animated" data-revert="rollOutLeft" data-animation="rollIn" src="<?php the_sub_field('image'); ?>" /> <span class="animated" data-revert="fadeOutLeft" data-animation="fadeInLeft" >
        <?php the_sub_field('title'); ?>
        </span> </a> </li>
      <?php } ?>
    </ul>
    <?php } ?>
    <a class="read-more" href="#clients"><img src="<?php bloginfo('template_directory'); ?>/images/read-more.png" /></a> </div>
  <!--container --> 
</div>
<div class="section" id="clients"> 
  ...
  <div class="container">
      ...
      <ul class="bxslider">
        ...
        <li>
          <div class="testimonial-mainnew">
            <div class="testimonial-authorimg"> <img src="<?php bloginfo('template_directory'); ?>/images/1-new.png" />
              <p class="testimonial-author"><?php echo $testimonial['client_name']; ?></p>
              <!-- <span class="author-city">Italy</span> --> 
            </div>
            <div class="testimonial-cont">
              <blockquote class="testimonial"> <?php echo $testimonial['description']; ?> </blockquote>
            </div>
          </div>
        </li>
        <?php 	                	echo $list;	                	$i++;					} ?>
    ...
    <a class="read-more" href="#portfolio"><img src="<?php bloginfo('template_directory'); ?>/images/read-more.png" /></a> </div>
  <!--container --> 
</div>
<div class="section" id="portfolio"> 
  ...
  <div class="container">
    ...
    <div class="portfolio_home portfolio_home_web">
      <div class="flexslider home_port"> <span class="animated" data-animation="bounceInDown" data-revert="bounceOutUp">Web Application</span>
        <ul class="slides">
          <?php
				...
				?>
          <li> <a href="<?php the_permalink();?>" title="<?php the_title(); ?>"> <img src="<?php echo get_field('image'); ?>">
            <p>
              <?php the_title(); ?>
            </p>
            </a> </li>
    ...
    <div class="portfolio_home">
      <div class="flexslider home_port"> <span class="animated" data-animation="bounceInDown" data-revert="bounceOutUp">Mobile Application</span>
        <ul class="slides">
          <?php
    ...
    <a class="read-more" href="#about"><img src="<?php bloginfo('template_directory'); ?>/images/read-more.png" /></a> </div>
  <!--container --> 
</div>
<div class="section" id="about" > 
  ...
  <div class="container">
    ...
    <span class="line animated" data-animation="bounceInLeft" data-revert="bounceOutRight">&nbsp;</span>
    <div class="sub-head animated"  data-animation="flipInX" data-revert="flipOutX">
      <?php the_sub_field('about_subtitle'); ?>
    </div>
    <?php } ?>
    <ul>
      <?php
		...
		?>
      <li>
        <h2 class="three_section lat_blog">Latest Blog</h2>
        <h3 class="animated" data-animation="fadeInDown" data-revert="fadeOutDown"><a href="<?php echo get_permalink(); ?>">
          <?php the_title();?>
          </a></h3>
        <p class="animated" data-animation="fadeIn" data-revert="fadeOut"> <?php echo get_excerpt_with_hashtag(170); ?> </p>
      </li>
      <?php  endwhile; wp_reset_query(); ?>
      <?php 
					...
					foreach( $myposts as $post ) :	setup_postdata($post);
                       ?>
      <li>
        <h2 class="three_section lat_news">Latest News</h2>
        <h3 class="animated" data-animation="fadeInDown" data-revert="fadeOutDown"><a href="<?php echo get_permalink(); ?>">
          <?php the_title();?>
          </a></h3>
        <p class="animated" data-animation="fadeIn" data-revert="fadeOut"> <?php echo get_excerpt_with_hashtag(150); ?> </p>
      </li>
      <?php  endforeach;  ?>
      <?php 
      ...
      <li>
        ...
        <p class="animated" data-animation="fadeIn" data-revert="fadeOut"> <?php echo get_excerpt_with_hashtag(160); ?> </p>
      </li>
      <?php  endforeach;  ?>
    </ul>
    <a class="read-more" href="#contact"><img src="<?php bloginfo('template_directory'); ?>/images/read-more.png" /></a> </div>
  <!--container --> 
</div>
<div class="section" id="contact"> 
  ...
  <div class="container">
    ...
    if( mt_rand(0,1) === 1 ) {
            $math = "$digit1 + $digit2";
            $answer = intval($digit1) + intval($digit2);
    } else {
            $math = "$digit1 - $digit2";
            $answer = intval($digit1) - intval($digit2);
			
    } 
	//echo "<script>alert(".$_SESSION['answer'].")</script>";
    ?>
    <form class="animated home_footer" data-animation="fadeInRight" data-revert="fadeOutRight" method="post" id="home_conct_form">
      <input type="hidden" name="scrollbottom" id="scrollbottom" />
      <input type="hidden" name="hiddenans" id="hiddenans" value="<?php echo $answer;?>" />
      <ul>
        <li>
        ...
        <li class="cpcha in_fot_cat">
          <p>What's <?php echo $math; ?> = </p>
          <input name="answer" type="text" id="answer"/>
          <p style="width: 245px ! important; text-align: right;"><?php echo $ctpwrong; ?></p>
          <br />
        </li>
        <li>
  ...
  <div class="cpy">
    ...
    Copyright © <?php echo date("Y"); ?> Lets Nurture. India | UK <a href="<?php echo get_permalink(5241); ?>" title="Sitemap">Sitemap</a> </div>
</div>
...
<script type="text/javascript">$(document).ready(function(){$('.bxslider').bxSlider({  minSlides: 2,  maxSlides: 2,  slideWidth: 800,  slideMargin: 10,  pager: false, 	auto: true,  touchEnabled: true,controls: false    });});</script>
<?php get_footer(); ?>
<style>
.section h2.three_section {     border-bottom: 2px solid rgba(255, 255, 255, 0.6);    font-size: 25px !important;    margin-left: 17%;    margin-top: 0 !important;    padding: 11px;}#about ul li h3 {
    margin-top: 4px;
    min-height: 65px;
    font-weight: normal;
}
