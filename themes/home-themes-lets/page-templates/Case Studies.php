<?php
/**
 * Template Name: Case Studies Page Tempale
 *
 * @package WordPress
...
<div id="grid-container" class="cbp-l-grid-team">
                <ul>
         			...
         			<?php 
         				...
         				$args = array( 'category_name'=>'case-studies','order'=>'DESC','posts_per_page'=>'-1' );
                            ...
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        <div class="cbp-l-caption-text">VIEW CASE STUDIES</div>
                                    </div>
                                </div>
                            </div>
                        </a>
